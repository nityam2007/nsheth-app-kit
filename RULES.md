...
6. Before using a TanStack API, search installed package types, Intent guidance, or the relevant local source under `reference/repos/github.com/TanStack/`. Do not guess APIs. Clone/read only the repository needed for the current task.
...
11. Follow `docs/BRAND.md`. Avoid generic template repetition, decorative gradients, glassmorphism, fake metrics/content, and effects without a functional purpose.
