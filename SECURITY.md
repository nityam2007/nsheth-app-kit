...
Report them through [GitHub private vulnerability reporting](https://github.com/nityam2007/nsheth-app-kit/security/advisories/new). If that form is unavailable, email [hello@nsheth.in](mailto:hello@nsheth.in) with the subject `NSheth App Kit security report`.

Include:

- the affected route, component, package, or commit;
