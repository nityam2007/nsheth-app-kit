      ...
      <Container className="max-w-3xl py-16">
        ...
        <div className="mb-10 space-y-5 leading-7 text-tertiary">
          <p>
            ...
            appointments, reservations, and orders. Sign-in uses a verified
            email with a password or GitHub, and a necessary HTTP-only session
            cookie lasting up to eight hours. Shopping cart items are stored in
            your browser; contact details are not stored in the cart.
          </p>
          <p>
            The operator must publish its identity, contact details, purposes,
            lawful bases, recipients, transfer arrangements, and retention
            periods before accepting real personal data. This starter notice is
            not a deployment-specific privacy policy.
          </p>
          <p>
