...
2. Current version: `0.1.1`. The TanStack, copied Untitled UI, identity, admin, and `@nsheth/content` foundations are complete and verified. Compose provides PostgreSQL; Node/npm run on the host.
