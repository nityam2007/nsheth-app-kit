...
2. Current version: `0.2.0`. The TanStack, copied Untitled UI, identity, admin, content/blog, and product catalogue/RFQ foundations are complete and verified. Compose provides PostgreSQL; Node/npm run on the host.
