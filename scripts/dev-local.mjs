...
try{
 ...
 if(!process.argv.includes('--check')){
  child=spawn(process.execPath,[resolve(root,'node_modules/vite/bin/vite.js'),'dev','--port','3000'],{cwd:resolve(root,'apps/playground'),env:database.env,stdio:'inherit',windowsHide:true})
